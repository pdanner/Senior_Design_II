...
public class GuiTextFollower : MonoBehaviour {
	...
	void Start () 
	{
		player = (PlayerScript) GameObject.FindObjectOfType(typeof(PlayerScript));
		...
		thisTransform.guiText.text = player.ammo.ToString();
	}
